  ...
  return (
    <div className="relative">
      ...
      <div className="w-14 h-16 right-2/4 translate-x-2/4 flex justify-between absolute top-11">
        ...
        >
          <div className="h-2/4 w-2 bg-blue-400 rounded-tl-lg"></div>
          <div
            className={`relative -top-1 w-2 transition h-2/4 translate-x-0 origin-top-right ${
              win && endGame ? 'rotate-90 -top-0' : 'rotate-0'
            }`}
          >
            <div className="w-full bg-blue-400 rounded-tr-sm h-full"></div>
            <div className="w-2 h-0 border-b-2 border-red-200 absolute"></div>
            <div
        ...
        >
          <div className="h-2/4 w-2 bg-blue-400 rounded-tr-lg"></div>
          <div className="relative w-2 transition h-2/4 translate-x-0 -top-1">
            <div className="w-full bg-blue-400 rounded-tr-sm h-full"></div>
            <div className="w-2 h-1.5 bg-red-200 absolute rounded-b-sm"></div>
          </div>
        </div>
      </div>
      <div className="-mt-1 flex justify-center">
        <div>
          ...
          <div className="w-9 h-10 flex justify-between">
            ...
            >
              <div className="w-3 h-8 bg-green-500 rotate-3 relative -top-2 rounded-full"></div>
              <div className="w-3 h-8 bg-green-500 -rotate-3 relative -top-4 rounded-full"></div>
              <div className="bg-yellow-900 w-4 h-2 relative -top-5 -left-1 rounded-tl-full rounded-b-sm -rotate-6"></div>
            </div>
            <div
            ...
            >
              <div className="w-3 h-8 bg-green-500 -rotate-3 relative -top-2 rounded-full"></div>
              <div className="w-3 h-8 bg-green-500 rotate-3 relative -top-4 rounded-full"></div>
              <div className="bg-yellow-900 w-4 h-2 relative -top-5 -right-0 rounded-tr-full rounded-b-sm rotate-6"></div>
            </div>
          </div>
        </div>
      </div>
